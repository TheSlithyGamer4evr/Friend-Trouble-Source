	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				case 1:
					#if PSYCH_WATERMARKS
					createCoolText(['FRIEND TROUBLE BY'], 15);
					#else
				...
				case 3:
					#if PSYCH_WATERMARKS
					addMoreText('Ninotron', 15);
					addMoreText('Cakieyee', 15);
					addMoreText('Punmaster', 15);
					addMoreText('TheSlithyGamer4evr', 15);
					addMoreText('TheOtherHand', 15);
					#else
					addMoreText('present');
					#end
				// credTextShit.text += '\npresent...';
