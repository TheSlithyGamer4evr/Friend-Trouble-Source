...
class NoteOffsetState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		FlxG.sound.pause();
		// Stage
		var bg:BGSprite = new BGSprite('dice', -300, -400, 0.9, 0.9);
		add(bg);

		var stageFront:BGSprite = new BGSprite('stagefront', -1050, 600, 0.9, 0.9);
		...
		// Characters
		boyfriend = new Character(770, 100, 'cakiebfnino', true);
