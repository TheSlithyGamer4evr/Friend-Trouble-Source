...
HXDLIN(  13)			 ::flixel::graphics::FlxGraphic imageLoaded = ::Paths_obj::addCustomGraphic(image);
...
HXLINE(  13)				 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(image);
HXDLIN(  13)				if (::hx::IsNotNull( imageToReturn )) {
HXLINE(  13)					_hx_tmp = imageToReturn;
            				}
            				else {
HXLINE(  13)					_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + image) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            				}
            			}
...
HXDLIN(  24)				 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(image);
HXDLIN(  24)				 ::Dynamic _hx_tmp;
HXDLIN(  24)				if (::hx::IsNotNull( imageToReturn )) {
HXLINE(  24)					_hx_tmp = imageToReturn;
            				}
            				else {
HXLINE(  24)					_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + image) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            				}
HXDLIN(  24)				this->loadGraphic(_hx_tmp,null(),null(),null(),null(),null());
            			}
