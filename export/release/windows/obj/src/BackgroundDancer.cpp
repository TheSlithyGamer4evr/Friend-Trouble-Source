...
HXDLIN(  12)		 ::flixel::graphics::FlxGraphic imageLoaded = ::Paths_obj::addCustomGraphic(HX_("limo/limoDancer",8e,b6,e5,ea));
...
HXDLIN(  12)		 ::Dynamic _hx_tmp;
HXDLIN(  12)		if (::hx::IsNotNull( imageLoaded )) {
HXLINE(  12)			_hx_tmp = imageLoaded;
            		}
            		else {
HXLINE(  12)			 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(HX_("limo/limoDancer",8e,b6,e5,ea));
HXDLIN(  12)			if (::hx::IsNotNull( imageToReturn )) {
HXLINE(  12)				_hx_tmp = imageToReturn;
            			}
            			else {
HXLINE(  12)				_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("limo/limoDancer",8e,b6,e5,ea)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            			}
            		}
HXDLIN(  12)		::String _hx_tmp1;
HXDLIN(  12)		if (xmlExists) {
HXLINE(  12)			_hx_tmp1 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + HX_("limo/limoDancer",8e,b6,e5,ea)) + HX_(".xml",69,3e,c3,1e))));
            		}
            		else {
HXLINE(  12)			_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("limo/limoDancer",8e,b6,e5,ea)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            		}
HXDLIN(  12)		this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,_hx_tmp1));
