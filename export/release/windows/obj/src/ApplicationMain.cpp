...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Trouble",97,2f,d5,70),::ApplicationMain_obj::create_dyn());
...
HXLINE(  35)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("155",d1,5c,25,00));
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("ShadowMario",e4,7d,20,5e));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Trouble",97,2f,d5,70));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Friend Trouble",f5,ef,d0,b7));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Friend Trouble",f5,ef,d0,b7))
...
HXLINE(  66)		attributes->__SetField(HX_("context",ef,95,77,19), ::Dynamic(::hx::Anon_obj::Create(8)
            			...
            			->setFixed(3,HX_("background",ee,93,1d,26),2691345)
