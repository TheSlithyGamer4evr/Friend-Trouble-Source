...
HXDLIN(  43)			 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(name);
HXDLIN(  43)			 ::Dynamic file;
HXDLIN(  43)			if (::hx::IsNotNull( imageToReturn )) {
HXLINE(  43)				file = imageToReturn;
            			}
            			else {
HXLINE(  43)				file = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + name) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            			}
