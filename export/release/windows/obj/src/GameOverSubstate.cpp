...
HXDLIN( 102)			::String file = ::Paths_obj::modFolders((((HX_("music/",ea,bf,1b,3f) + HX_("freakyMenu",15,c9,93,86)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)));
HXDLIN( 102)			 ::Dynamic _hx_tmp1;
HXDLIN( 102)			if (::sys::FileSystem_obj::exists(file)) {
HXLINE( 102)				if (!(::Paths_obj::customSoundsLoaded->exists(file))) {
HXLINE( 102)					::Dynamic this1 = ::Paths_obj::customSoundsLoaded;
HXDLIN( 102)					( ( ::haxe::ds::StringMap)(this1) )->set(file,::openfl::media::Sound_obj::fromFile(file));
            				}
HXDLIN( 102)				_hx_tmp1 = ::Paths_obj::customSoundsLoaded->get(file);
            			}
            			else {
HXLINE( 102)				_hx_tmp1 = ::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + HX_("freakyMenu",15,c9,93,86)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library);
            			}
...
HXDLIN( 140)		::String key = ::GameOverSubstate_obj::loopSoundName;
HXDLIN( 140)		::String library = null();
HXDLIN( 140)		::String file = ::Paths_obj::modFolders((((HX_("music/",ea,bf,1b,3f) + key) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)));
HXDLIN( 140)		 ::Dynamic _hx_tmp1;
...
HXDLIN( 140)			_hx_tmp1 = ::Paths_obj::customSoundsLoaded->get(file);
            		}
            		else {
HXDLIN( 140)			_hx_tmp1 = ::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + key) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library);
            		}
HXDLIN( 140)		_hx_tmp->playMusic(_hx_tmp1,volume,null(),null());
            	}
...
HXDLIN( 150)			::String key = ::GameOverSubstate_obj::endSoundName;
HXDLIN( 150)			::String library = null();
HXDLIN( 150)			::String file = ::Paths_obj::modFolders((((HX_("music/",ea,bf,1b,3f) + key) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)));
HXDLIN( 150)			 ::Dynamic _hx_tmp1;
HXDLIN( 150)			if (::sys::FileSystem_obj::exists(file)) {
HXLINE( 150)				if (!(::Paths_obj::customSoundsLoaded->exists(file))) {
HXLINE( 150)					::Dynamic this1 = ::Paths_obj::customSoundsLoaded;
HXDLIN( 150)					( ( ::haxe::ds::StringMap)(this1) )->set(file,::openfl::media::Sound_obj::fromFile(file));
            				}
HXDLIN( 150)				_hx_tmp1 = ::Paths_obj::customSoundsLoaded->get(file);
            			}
            			else {
HXLINE( 150)				_hx_tmp1 = ::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + key) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library);
            			}
HXDLIN( 150)			_hx_tmp->play(_hx_tmp1,null(),null(),null(),null(),null());
...
HXLINE(  30)		::GameOverSubstate_obj::characterName = HX_("cakiebf",2d,5f,ff,be);
...
HXDLIN(  22)		characterName = HX_("cakiebf",2d,5f,ff,be);
            	}
{
