...
HXDLIN(  62)		 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(HX_("menuBGoptions",ba,7a,4f,04));
HXDLIN(  62)		 ::Dynamic bg1;
HXDLIN(  62)		if (::hx::IsNotNull( imageToReturn )) {
HXLINE(  62)			bg1 = imageToReturn;
            		}
            		else {
