...
HX_DEFINE_STACK_FRAME(_hx_pos_6f866b21df2f4ee6_1839_new,"DebugLuaText","new",0xad824284,"DebugLuaText.new","FunkinLua.hx",1839,0x00117937)
HX_LOCAL_STACK_FRAME(_hx_pos_6f866b21df2f4ee6_1851_update,"DebugLuaText","update",0x3cb60265,"DebugLuaText.update","FunkinLua.hx",1851,0x00117937)

void DebugLuaText_obj::__construct(::String text, ::flixel::group::FlxTypedGroup parentGroup){
            	HX_STACKFRAME(&_hx_pos_6f866b21df2f4ee6_1839_new)
HXLINE(1841)		this->disableTime = ((Float)6);
HXLINE(1844)		this->parentGroup = parentGroup;
HXLINE(1845)		super::__construct(10,10,0,text,16,null());
HXLINE(1846)		::String file = ::Paths_obj::modFolders((HX_("fonts/",eb,13,ef,fa) + HX_("vcr.ttf",9d,d2,a7,82)));
HXDLIN(1846)		::String _hx_tmp;
HXDLIN(1846)		if (::sys::FileSystem_obj::exists(file)) {
HXLINE(1846)			_hx_tmp = file;
            		}
            		else {
HXLINE(1846)			_hx_tmp = (HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82));
            		}
HXDLIN(1846)		this->setFormat(_hx_tmp,20,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE(1847)		this->scrollFactor->set(null(),null());
HXLINE(1848)		this->set_borderSize(( (Float)(1) ));
            	}
...
void DebugLuaText_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_6f866b21df2f4ee6_1851_update)
HXLINE(1852)		this->super::update(elapsed);
HXLINE(1853)		 ::DebugLuaText _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(1853)		_hx_tmp->disableTime = (_hx_tmp->disableTime - elapsed);
HXLINE(1854)		if ((this->disableTime <= 0)) {
HXLINE(1855)			this->kill();
HXLINE(1856)			this->parentGroup->remove(::hx::ObjectPtr<OBJ_>(this),null()).StaticCast<  ::DebugLuaText >();
HXLINE(1857)			this->destroy();
            		}
            		else {
HXLINE(1859)			if ((this->disableTime < 1)) {
HXLINE(1859)				this->set_alpha(this->disableTime);
            			}
            		}
            	}
