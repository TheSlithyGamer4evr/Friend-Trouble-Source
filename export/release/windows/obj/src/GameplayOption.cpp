...
HX_DEFINE_STACK_FRAME(_hx_pos_5355c1500aa58f96_325_new,"GameplayOption","new",0x2ac2d98d,"GameplayOption.new","GameplayChangersSubstate.hx",325,0xb1374db6)
HX_LOCAL_STACK_FRAME(_hx_pos_5355c1500aa58f96_402_change,"GameplayOption","change",0x8d0dc263,"GameplayOption.change","GameplayChangersSubstate.hx",402,0xb1374db6)
HX_LOCAL_STACK_FRAME(_hx_pos_5355c1500aa58f96_409_getValue,"GameplayOption","getValue",0x690f22ae,"GameplayOption.getValue","GameplayChangersSubstate.hx",409,0xb1374db6)
HX_LOCAL_STACK_FRAME(_hx_pos_5355c1500aa58f96_413_setValue,"GameplayOption","setValue",0x176c7c22,"GameplayOption.setValue","GameplayChangersSubstate.hx",413,0xb1374db6)
HX_LOCAL_STACK_FRAME(_hx_pos_5355c1500aa58f96_418_setChild,"GameplayOption","setChild",0x2b6da64d,"GameplayOption.setChild","GameplayChangersSubstate.hx",418,0xb1374db6)
HX_LOCAL_STACK_FRAME(_hx_pos_5355c1500aa58f96_422_get_text,"GameplayOption","get_text",0xa4341be9,"GameplayOption.get_text","GameplayChangersSubstate.hx",422,0xb1374db6)
HX_LOCAL_STACK_FRAME(_hx_pos_5355c1500aa58f96_429_set_text,"GameplayOption","set_text",0x5291755d,"GameplayOption.set_text","GameplayChangersSubstate.hx",429,0xb1374db6)
HX_LOCAL_STACK_FRAME(_hx_pos_5355c1500aa58f96_437_get_type,"GameplayOption","get_type",0xa44341f6,"GameplayOption.get_type","GameplayChangersSubstate.hx",437,0xb1374db6)
...
void GameplayOption_obj::__construct(::String name,::String variable,::String __o_type, ::Dynamic __o_defaultValue,::Array< ::String > options){
            	...
            	HX_STACKFRAME(&_hx_pos_5355c1500aa58f96_325_new)
HXLINE( 349)		this->name = HX_("Unknown",6a,4b,cc,ae);
HXLINE( 348)		this->displayFormat = HX_("%v",b1,20,00,00);
HXLINE( 346)		this->decimals = 1;
HXLINE( 345)		this->maxValue = null();
HXLINE( 344)		this->minValue = null();
HXLINE( 343)		this->changeValue = 1;
HXLINE( 342)		this->options = null();
HXLINE( 341)		this->curOption = 0;
HXLINE( 339)		this->defaultValue = null();
HXLINE( 338)		this->variable = null();
HXLINE( 336)		this->scrollSpeed = ((Float)50);
HXLINE( 335)		this->showBoyfriend = false;
HXLINE( 331)		this->type = HX_("bool",2a,84,1b,41);
HXLINE( 329)		this->onChange = null();
HXLINE( 353)		this->name = name;
HXLINE( 354)		this->variable = variable;
HXLINE( 355)		this->type = type;
HXLINE( 356)		this->defaultValue = defaultValue;
HXLINE( 357)		this->options = options;
HXLINE( 359)		if (::hx::IsEq( defaultValue,HX_("null variable value",06,3c,3f,e9) )) {
HXLINE( 361)			::String _hx_switch_0 = type;
            			if (  (_hx_switch_0==HX_("bool",2a,84,1b,41)) ){
HXLINE( 364)				defaultValue = false;
HXDLIN( 364)				goto _hx_goto_0;
            			}
            			if (  (_hx_switch_0==HX_("float",9c,c5,96,02)) ||  (_hx_switch_0==HX_("int",ef,0c,50,00)) ){
HXLINE( 366)				defaultValue = 0;
HXDLIN( 366)				goto _hx_goto_0;
            			}
            			if (  (_hx_switch_0==HX_("percent",c5,aa,da,78)) ){
HXLINE( 368)				defaultValue = 1;
HXDLIN( 368)				goto _hx_goto_0;
            			}
            			if (  (_hx_switch_0==HX_("string",d1,28,30,11)) ){
HXLINE( 370)				defaultValue = HX_("",00,00,00,00);
HXLINE( 371)				if ((options->length > 0)) {
HXLINE( 372)					defaultValue = options->__get(0);
            				}
HXLINE( 369)				goto _hx_goto_0;
            			}
            			_hx_goto_0:;
            		}
HXLINE( 377)		if (::hx::IsNull( this->getValue() )) {
HXLINE( 378)			this->setValue(defaultValue);
            		}
HXLINE( 381)		::String _hx_switch_1 = type;
            		if (  (_hx_switch_1==HX_("percent",c5,aa,da,78)) ){
HXLINE( 390)			this->displayFormat = HX_("%v%",54,7a,1c,00);
HXLINE( 391)			this->changeValue = ((Float)0.01);
HXLINE( 392)			this->minValue = 0;
HXLINE( 393)			this->maxValue = 1;
HXLINE( 394)			this->scrollSpeed = ((Float)0.5);
HXLINE( 395)			this->decimals = 2;
HXLINE( 389)			goto _hx_goto_1;
            		}
            		if (  (_hx_switch_1==HX_("string",d1,28,30,11)) ){
HXLINE( 384)			int num = options->indexOf(this->getValue(),null());
HXLINE( 385)			if ((num > -1)) {
HXLINE( 386)				this->curOption = num;
            			}
...
void GameplayOption_obj::change(){
            	HX_STACKFRAME(&_hx_pos_5355c1500aa58f96_402_change)
HXDLIN( 402)		if (::hx::IsNotNull( this->onChange )) {
HXLINE( 403)			this->onChange();
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(GameplayOption_obj,change,(void))
 ...
 ::Dynamic GameplayOption_obj::getValue(){
            	HX_STACKFRAME(&_hx_pos_5355c1500aa58f96_409_getValue)
HXDLIN( 409)		return ::ClientPrefs_obj::gameplaySettings->get(this->variable);
            	}
...
void GameplayOption_obj::setValue( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_5355c1500aa58f96_413_setValue)
HXDLIN( 413)		::ClientPrefs_obj::gameplaySettings->set(this->variable,value);
            	}
...
void GameplayOption_obj::setChild( ::Alphabet child){
            	HX_STACKFRAME(&_hx_pos_5355c1500aa58f96_418_setChild)
HXDLIN( 418)		this->child = child;
            	}
...
::String GameplayOption_obj::get_text(){
            	HX_STACKFRAME(&_hx_pos_5355c1500aa58f96_422_get_text)
HXLINE( 423)		if (::hx::IsNotNull( this->child )) {
HXLINE( 424)			return this->child->text;
            		}
...
::String GameplayOption_obj::set_text(::String __o_newValue){
            	...
            	HX_STACKFRAME(&_hx_pos_5355c1500aa58f96_429_set_text)
HXLINE( 430)		if (::hx::IsNotNull( this->child )) {
HXLINE( 431)			this->child->changeText(newValue,null());
            		}
...
::String GameplayOption_obj::get_type(){
            	HX_STACKFRAME(&_hx_pos_5355c1500aa58f96_437_get_type)
HXLINE( 438)		::String newValue = HX_("bool",2a,84,1b,41);
HXLINE( 439)		::String _hx_switch_0 = ::StringTools_obj::trim(this->type.toLowerCase());
            		if (  (_hx_switch_0==HX_("fl",46,59,00,00)) ){
HXLINE( 444)			newValue = HX_("float",9c,c5,96,02);
HXDLIN( 444)			goto _hx_goto_9;
            		}
            		if (  (_hx_switch_0==HX_("integer",be,bd,1b,17)) ){
HXLINE( 442)			newValue = HX_("int",ef,0c,50,00);
HXDLIN( 442)			goto _hx_goto_9;
            		}
...
HXLINE( 441)			newValue = this->type;
HXDLIN( 441)			goto _hx_goto_9;
            		}
            		if (  (_hx_switch_0==HX_("str",b1,a8,57,00)) ){
HXLINE( 443)			newValue = HX_("string",d1,28,30,11);
HXDLIN( 443)			goto _hx_goto_9;
            		}
            		_hx_goto_9:;
HXLINE( 446)		this->type = newValue;
HXLINE( 447)		return this->type;
            	}
