...
HXDLIN(  14)		 ::flixel::graphics::FlxGraphic imageLoaded = ::Paths_obj::addCustomGraphic(HX_("weeb/bgFreaks",d9,71,bd,0f));
...
HXLINE(  14)			 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(HX_("weeb/bgFreaks",d9,71,bd,0f));
HXDLIN(  14)			if (::hx::IsNotNull( imageToReturn )) {
HXLINE(  14)				_hx_tmp = imageToReturn;
            			}
            			else {
HXLINE(  14)				_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/bgFreaks",d9,71,bd,0f)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            			}
            		}
