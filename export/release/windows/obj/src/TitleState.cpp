...
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_198_create,"TitleState","create",0x801cc151,"TitleState.create","TitleState.hx",198,0xd132a6e5)
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_211_startIntro,"TitleState","startIntro",0x6a094b7f,"TitleState.startIntro","TitleState.hx",211,0xd132a6e5)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_383_getIntroTextShit,"TitleState","getIntroTextShit",0x5dcf15b8,"TitleState.getIntroTextShit","TitleState.hx",383,0xd132a6e5)
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_400_update,"TitleState","update",0x8b12e05e,"TitleState.update","TitleState.hx",400,0xd132a6e5)
...
static const ::String _hx_array_data_8ca18d79_21[] = {
	HX_("FRIEND TROUBLE BY",42,21,88,d6),
};
...
HXLINE( 206)		this->danceLeft = false;
...
HXLINE(  85)			::Array< ::String > list = ::CoolUtil_obj::listFromString(::sys::io::File_obj::getContent(HX_("modsList.txt",f1,ca,08,ac)));
HXLINE(  86)			bool foundTheTop = false;
HXLINE(  87)			{
HXLINE(  87)				int _g = 0;
HXDLIN(  87)				while((_g < list->length)){
HXLINE(  87)					::String i = list->__get(_g);
HXDLIN(  87)					_g = (_g + 1);
HXLINE(  88)					::Array< ::String > dat = i.split(HX_("|",7c,00,00,00));
HXLINE(  89)					bool _hx_tmp;
HXDLIN(  89)					if ((dat->__get(1) == HX_("1",31,00,00,00))) {
HXLINE(  89)						_hx_tmp = !(foundTheTop);
            					}
            					else {
HXLINE(  89)						_hx_tmp = false;
            					}
HXDLIN(  89)					if (_hx_tmp) {
HXLINE(  90)						foundTheTop = true;
HXLINE(  91)						::Paths_obj::currentModDirectory = dat->__get(0);
            					}
            				}
            			}
            		}
HXLINE(  99)		::String path = ((HX_("mods/",9e,2f,58,0c) + ::Paths_obj::currentModDirectory) + HX_("/images/gfDanceTitle.json",4a,b1,03,a5));
HXLINE( 101)		if (!(::sys::FileSystem_obj::exists(path))) {
HXLINE( 102)			path = HX_("mods/images/gfDanceTitle.json",b9,75,53,37);
            		}
HXLINE( 105)		if (!(::sys::FileSystem_obj::exists(path))) {
HXLINE( 106)			path = HX_("assets/images/gfDanceTitle.json",67,8a,5f,c5);
            		}
HXLINE( 109)		this->titleJSON =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,::sys::io::File_obj::getContent(path))->doParse();
HXLINE( 154)		::flixel::FlxG_obj::game->focusLostFramerate = 60;
HXLINE( 155)		::flixel::FlxG_obj::sound->muteKeys = ::TitleState_obj::muteKeys;
HXLINE( 156)		::flixel::FlxG_obj::sound->volumeDownKeys = ::TitleState_obj::volumeDownKeys;
HXLINE( 157)		::flixel::FlxG_obj::sound->volumeUpKeys = ::TitleState_obj::volumeUpKeys;
HXLINE( 158)		::flixel::FlxG_obj::keys->preventDefaultKeys = ::Array_obj< int >::fromData( _hx_array_data_8ca18d79_4,1);
HXLINE( 160)		::PlayerSettings_obj::init();
HXLINE( 162)		 ::flixel::math::FlxRandom _hx_tmp = ::flixel::FlxG_obj::random;
HXDLIN( 162)		this->curWacky = _hx_tmp->getObject_Array_String(this->getIntroTextShit(),null(),null(),null());
HXLINE( 166)		this->swagShader =  ::ColorSwap_obj::__alloc( HX_CTX );
HXLINE( 167)		this->super::create();
HXLINE( 169)		::flixel::FlxG_obj::save->bind(HX_("funkin",31,b2,4f,6f),HX_("ninjamuffin99",f7,4c,e5,00));
HXLINE( 170)		::ClientPrefs_obj::loadPrefs();
HXLINE( 172)		::Highscore_obj::load();
HXLINE( 174)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("weekCompleted",f7,82,ec,84),::hx::paccDynamic) )) {
HXLINE( 176)			::StoryMenuState_obj::weekCompleted = ( ( ::haxe::ds::StringMap)(::flixel::FlxG_obj::save->data->__Field(HX_("weekCompleted",f7,82,ec,84),::hx::paccDynamic)) );
            		}
HXLINE( 179)		::flixel::FlxG_obj::mouse->set_visible(false);
HXLINE( 185)		bool _hx_tmp1;
HXDLIN( 185)		if (::hx::IsNull( ::flixel::FlxG_obj::save->data->__Field(HX_("flashing",32,85,e8,99),::hx::paccDynamic) )) {
HXLINE( 185)			_hx_tmp1 = !(::FlashingState_obj::leftState);
            		}
            		else {
HXLINE( 185)			_hx_tmp1 = false;
            		}
HXDLIN( 185)		if (_hx_tmp1) {
HXLINE( 186)			::flixel::addons::transition::FlxTransitionableState_obj::skipNextTransIn = true;
HXLINE( 187)			::flixel::addons::transition::FlxTransitionableState_obj::skipNextTransOut = true;
HXLINE( 188)			::MusicBeatState_obj::switchState( ::FlashingState_obj::__alloc( HX_CTX ,null(),null()));
            		}
            		else {
            			HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            			void _hx_run(int exitCode){
            				HX_GC_STACKFRAME(&_hx_pos_a55214e0452daa02_193_create)
HXLINE( 193)				::DiscordClient_obj::shutdown();
            			}
            			HX_END_LOCAL_FUNC1((void))

            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_1, ::TitleState,_gthis) HXARGC(1)
            			void _hx_run( ::flixel::util::FlxTimer tmr){
            				HX_GC_STACKFRAME(&_hx_pos_a55214e0452daa02_198_create)
HXLINE( 198)				_gthis->startIntro();
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE( 191)			::DiscordClient_obj::initialize();
HXLINE( 192)			::lime::app::Application_obj::current->onExit->add( ::Dynamic(new _hx_Closure_0()),null(),null());
HXLINE( 196)			 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(1, ::Dynamic(new _hx_Closure_1(_gthis)),null());
            		}
            	}


void TitleState_obj::startIntro(){
            	HX_GC_STACKFRAME(&_hx_pos_a55214e0452daa02_211_startIntro)
HXLINE( 212)		if (!(::TitleState_obj::initialized)) {
HXLINE( 235)			if (::hx::IsNull( ::flixel::FlxG_obj::sound->music )) {
HXLINE( 236)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 236)				::String library = null();
HXDLIN( 236)				::String file = ::Paths_obj::modFolders((((HX_("music/",ea,bf,1b,3f) + HX_("freakyMenu",15,c9,93,86)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)));
HXDLIN( 236)				 ::Dynamic _hx_tmp1;
HXDLIN( 236)				if (::sys::FileSystem_obj::exists(file)) {
HXLINE( 236)					if (!(::Paths_obj::customSoundsLoaded->exists(file))) {
HXLINE( 236)						::Dynamic this1 = ::Paths_obj::customSoundsLoaded;
HXDLIN( 236)						( ( ::haxe::ds::StringMap)(this1) )->set(file,::openfl::media::Sound_obj::fromFile(file));
            					}
HXDLIN( 236)					_hx_tmp1 = ::Paths_obj::customSoundsLoaded->get(file);
            				}
            				else {
HXLINE( 236)					_hx_tmp1 = ::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + HX_("freakyMenu",15,c9,93,86)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library);
            				}
HXDLIN( 236)				_hx_tmp->playMusic(_hx_tmp1,0,null(),null());
HXLINE( 238)				{
...
HXLINE( 242)		::Conductor_obj::changeBPM(( (Float)(this->titleJSON->__Field(HX_("bpm",df,be,4a,00),::hx::paccDynamic)) ));
HXLINE( 243)		this->persistentUpdate = true;
HXLINE( 245)		 ::flixel::FlxSprite bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null());
HXLINE( 247)		bool _hx_tmp;
HXDLIN( 247)		bool _hx_tmp1;
HXDLIN( 247)		if (::hx::IsNotNull( this->titleJSON->__Field(HX_("backgroundSprite",93,8a,2c,8e),::hx::paccDynamic) )) {
HXLINE( 247)			_hx_tmp1 = (( (::String)(this->titleJSON->__Field(HX_("backgroundSprite",93,8a,2c,8e),::hx::paccDynamic)) ).length > 0);
            		}
            		else {
HXLINE( 247)			_hx_tmp1 = false;
            		}
HXDLIN( 247)		if (_hx_tmp1) {
HXLINE( 247)			_hx_tmp = ::hx::IsNotEq( this->titleJSON->__Field(HX_("backgroundSprite",93,8a,2c,8e),::hx::paccDynamic),HX_("none",b8,12,0a,49) );
            		}
            		else {
HXLINE( 247)			_hx_tmp = false;
            		}
HXDLIN( 247)		if (_hx_tmp) {
HXLINE( 248)			::String key = ( (::String)(this->titleJSON->__Field(HX_("backgroundSprite",93,8a,2c,8e),::hx::paccDynamic)) );
HXDLIN( 248)			::String library = null();
HXDLIN( 248)			 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(key);
HXDLIN( 248)			 ::Dynamic _hx_tmp;
HXDLIN( 248)			if (::hx::IsNotNull( imageToReturn )) {
HXLINE( 248)				_hx_tmp = imageToReturn;
            			}
            			else {
HXLINE( 248)				_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            			}
HXDLIN( 248)			bg->loadGraphic(_hx_tmp,null(),null(),null(),null(),null());
            		}
            		else {
HXLINE( 250)			bg->makeGraphic(::flixel::FlxG_obj::width,::flixel::FlxG_obj::height,-16777216,null(),null());
            		}
HXLINE( 260)		this->add(bg);
HXLINE( 262)		this->logoBl =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,this->titleJSON->__Field(HX_("titlex",e0,cf,77,23),::hx::paccDynamic),this->titleJSON->__Field(HX_("titley",e1,cf,77,23),::hx::paccDynamic),null());
HXLINE( 266)		::String path = ((HX_("mods/",9e,2f,58,0c) + ::Paths_obj::currentModDirectory) + HX_("/images/logoBumpin.png",89,bd,72,fd));
HXLINE( 268)		if (!(::sys::FileSystem_obj::exists(path))) {
HXLINE( 269)			path = HX_("mods/images/logoBumpin.png",ba,6d,b4,ff);
            		}
HXLINE( 272)		if (!(::sys::FileSystem_obj::exists(path))) {
HXLINE( 273)			path = HX_("assets/images/logoBumpin.png",4c,c0,28,86);
            		}
HXLINE( 276)		 ::flixel::FlxSprite _hx_tmp2 = this->logoBl;
HXDLIN( 276)		 ::openfl::display::BitmapData _hx_tmp3 = ::openfl::display::BitmapData_obj::fromFile(path);
HXDLIN( 276)		_hx_tmp2->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp3,::sys::io::File_obj::getContent(::StringTools_obj::replace(path,HX_(".png",3b,2d,bd,1e),HX_(".xml",69,3e,c3,1e)))));
HXLINE( 282)		this->logoBl->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE( 283)		this->logoBl->animation->addByPrefix(HX_("bump",f6,0f,20,41),HX_("logo bumpin",70,a1,0b,72),24,false,null(),null());
HXLINE( 284)		this->logoBl->animation->play(HX_("bump",f6,0f,20,41),null(),null(),null());
HXLINE( 285)		this->logoBl->updateHitbox();
HXLINE( 289)		this->swagShader =  ::ColorSwap_obj::__alloc( HX_CTX );
HXLINE( 290)		this->gfDance =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,this->titleJSON->__Field(HX_("gfx",79,81,4e,00),::hx::paccDynamic),this->titleJSON->__Field(HX_("gfy",7a,81,4e,00),::hx::paccDynamic),null());
HXLINE( 293)		::String path1 = ((HX_("mods/",9e,2f,58,0c) + ::Paths_obj::currentModDirectory) + HX_("/images/gfDanceTitle.png",c7,a7,3b,2b));
HXLINE( 295)		if (!(::sys::FileSystem_obj::exists(path1))) {
HXLINE( 296)			path1 = HX_("mods/images/gfDanceTitle.png",38,86,6e,85);
            		}
HXLINE( 299)		if (!(::sys::FileSystem_obj::exists(path1))) {
HXLINE( 300)			path1 = HX_("assets/images/gfDanceTitle.png",4a,21,8a,cf);
            		}
HXLINE( 303)		 ::flixel::FlxSprite _hx_tmp4 = this->gfDance;
HXDLIN( 303)		 ::openfl::display::BitmapData _hx_tmp5 = ::openfl::display::BitmapData_obj::fromFile(path1);
HXDLIN( 303)		_hx_tmp4->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp5,::sys::io::File_obj::getContent(::StringTools_obj::replace(path1,HX_(".png",3b,2d,bd,1e),HX_(".xml",69,3e,c3,1e)))));
HXLINE( 308)		this->gfDance->animation->addByIndices(HX_("danceLeft",da,cc,f9,df),HX_("gfDance",94,88,3a,eb),::Array_obj< int >::fromData( _hx_array_data_8ca18d79_8,16),HX_("",00,00,00,00),24,false,null(),null());
HXLINE( 309)		this->gfDance->animation->addByIndices(HX_("danceRight",a9,7f,a6,91),HX_("gfDance",94,88,3a,eb),::Array_obj< int >::fromData( _hx_array_data_8ca18d79_9,15),HX_("",00,00,00,00),24,false,null(),null());
HXLINE( 311)		this->gfDance->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE( 312)		this->add(this->gfDance);
HXLINE( 313)		this->gfDance->shader = this->swagShader->shader;
HXLINE( 314)		this->add(this->logoBl);
HXLINE( 317)		this->titleText =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,this->titleJSON->__Field(HX_("startx",d6,61,fa,05),::hx::paccDynamic),this->titleJSON->__Field(HX_("starty",d7,61,fa,05),::hx::paccDynamic),null());
HXLINE( 319)		::String path2 = ((HX_("mods/",9e,2f,58,0c) + ::Paths_obj::currentModDirectory) + HX_("/images/titleEnter.png",c3,97,17,95));
HXLINE( 321)		if (!(::sys::FileSystem_obj::exists(path2))) {
HXLINE( 322)			path2 = HX_("mods/images/titleEnter.png",f4,47,59,97);
            		}
HXLINE( 325)		if (!(::sys::FileSystem_obj::exists(path2))) {
HXLINE( 326)			path2 = HX_("assets/images/titleEnter.png",86,9a,cd,1d);
            		}
HXLINE( 329)		 ::flixel::FlxSprite _hx_tmp6 = this->titleText;
HXDLIN( 329)		 ::openfl::display::BitmapData _hx_tmp7 = ::openfl::display::BitmapData_obj::fromFile(path2);
HXDLIN( 329)		_hx_tmp6->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp7,::sys::io::File_obj::getContent(::StringTools_obj::replace(path2,HX_(".png",3b,2d,bd,1e),HX_(".xml",69,3e,c3,1e)))));
HXLINE( 334)		this->titleText->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("Press Enter to Begin",e9,79,2c,83),24,null(),null(),null());
HXLINE( 335)		this->titleText->animation->addByPrefix(HX_("press",83,53,88,c8),HX_("ENTER PRESSED",5a,47,9f,63),24,null(),null(),null());
HXLINE( 336)		this->titleText->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE( 337)		this->titleText->animation->play(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 338)		this->titleText->updateHitbox();
HXLINE( 340)		this->add(this->titleText);
HXLINE( 342)		 ::flixel::FlxSprite logo =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null());
HXDLIN( 342)		::String library = null();
HXDLIN( 342)		 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(HX_("logo",6b,9f,b7,47));
HXDLIN( 342)		 ::Dynamic logo1;
HXDLIN( 342)		if (::hx::IsNotNull( imageToReturn )) {
HXLINE( 342)			logo1 = imageToReturn;
            		}
            		else {
HXLINE( 342)			logo1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("logo",6b,9f,b7,47)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            		}
HXDLIN( 342)		 ::flixel::FlxSprite logo2 = logo->loadGraphic(logo1,null(),null(),null(),null(),null());
HXLINE( 343)		logo2->screenCenter(null());
HXLINE( 344)		logo2->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE( 350)		this->credGroup =  ::flixel::group::FlxTypedGroup_obj::__alloc( HX_CTX ,null());
HXLINE( 351)		this->add(this->credGroup);
HXLINE( 352)		this->textGroup =  ::flixel::group::FlxTypedGroup_obj::__alloc( HX_CTX ,null());
HXLINE( 354)		this->blackScreen =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null())->makeGraphic(::flixel::FlxG_obj::width,::flixel::FlxG_obj::height,-16777216,null(),null());
HXLINE( 355)		this->credGroup->add(this->blackScreen).StaticCast<  ::flixel::FlxBasic >();
HXLINE( 357)		this->credTextShit =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),HX_("",00,00,00,00),true,null(),null(),null());
HXLINE( 358)		this->credTextShit->screenCenter(null());
HXLINE( 362)		this->credTextShit->set_visible(false);
HXLINE( 364)		 ::flixel::FlxSprite _hx_tmp8 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,(( (Float)(::flixel::FlxG_obj::height) ) * ((Float)0.52)),null());
HXDLIN( 364)		::String library1 = null();
HXDLIN( 364)		 ::flixel::graphics::FlxGraphic imageToReturn1 = ::Paths_obj::addCustomGraphic(HX_("newgrounds_logo",1e,5c,8d,a6));
HXDLIN( 364)		 ::Dynamic _hx_tmp9;
HXDLIN( 364)		if (::hx::IsNotNull( imageToReturn1 )) {
HXLINE( 364)			_hx_tmp9 = imageToReturn1;
            		}
            		else {
HXLINE( 364)			_hx_tmp9 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("newgrounds_logo",1e,5c,8d,a6)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1);
            		}
HXDLIN( 364)		this->ngSpr = _hx_tmp8->loadGraphic(_hx_tmp9,null(),null(),null(),null(),null());
HXLINE( 365)		this->add(this->ngSpr);
HXLINE( 366)		this->ngSpr->set_visible(false);
HXLINE( 367)		 ::flixel::FlxSprite _hx_tmp10 = this->ngSpr;
HXDLIN( 367)		_hx_tmp10->setGraphicSize(::Std_obj::_hx_int((this->ngSpr->get_width() * ((Float)0.8))),null());
HXLINE( 368)		this->ngSpr->updateHitbox();
HXLINE( 369)		this->ngSpr->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE( 370)		this->ngSpr->set_antialiasing(true);
HXLINE( 372)		::flixel::tweens::FlxTween_obj::tween(this->credTextShit, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE( 374)		if (::TitleState_obj::initialized) {
HXLINE( 375)			this->skipIntro();
            		}
            		else {
HXLINE( 377)			::TitleState_obj::initialized = true;
            		}
            	}
...
::Array< ::Dynamic> TitleState_obj::getIntroTextShit(){
            	HX_STACKFRAME(&_hx_pos_a55214e0452daa02_383_getIntroTextShit)
HXLINE( 384)		::String library = null();
HXDLIN( 384)		::String fullText = ::openfl::utils::Assets_obj::getText(::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + HX_("introText",39,69,67,a6)) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library));
HXLINE( 386)		::Array< ::String > firstArray = fullText.split(HX_("\n",0a,00,00,00));
HXLINE( 387)		::Array< ::Dynamic> swagGoodArray = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 389)		{
HXLINE( 389)			int _g = 0;
HXDLIN( 389)			while((_g < firstArray->length)){
HXLINE( 389)				::String i = firstArray->__get(_g);
HXDLIN( 389)				_g = (_g + 1);
HXLINE( 391)				swagGoodArray->push(i.split(HX_("--",60,27,00,00)));
            			}
            		}
HXLINE( 394)		return swagGoodArray;
            	}
...
void TitleState_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_a55214e0452daa02_400_update)
HXDLIN( 400)		 ::TitleState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 401)		if (::hx::IsNotNull( ::flixel::FlxG_obj::sound->music )) {
HXLINE( 402)			::Conductor_obj::songPosition = ::flixel::FlxG_obj::sound->music->_time;
            		}
HXLINE( 405)		 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 405)		if (_this->keyManager->checkStatus(70,_this->status)) {
HXLINE( 407)			::flixel::FlxG_obj::set_fullscreen(!(::flixel::FlxG_obj::get_fullscreen()));
            		}
HXLINE( 410)		bool pressedEnter;
HXDLIN( 410)		 ::flixel::input::keyboard::FlxKeyList _this1 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 410)		if (!(_this1->keyManager->checkStatus(13,_this1->status))) {
...
HXDLIN( 437)		if (!(this->transitioning)) {
...
HXLINE( 577)					this->createCoolText(::Array_obj< ::String >::fromData( _hx_array_data_8ca18d79_21,1),15);
            				...
            				break;
            				case (int)3: {
HXLINE( 584)					this->addMoreText(HX_("Ninotron",79,31,6c,ad),15);
HXLINE( 585)					this->addMoreText(HX_("Cakieyee",b0,17,37,3a),15);
HXLINE( 586)					this->addMoreText(HX_("Punmaster",0b,80,d8,a8),15);
HXLINE( 587)					this->addMoreText(HX_("TheSlithyGamer4evr",87,e6,e5,ee),15);
HXLINE( 588)					this->addMoreText(HX_("TheOtherHand",ce,1b,3b,e8),15);
            				}
            				break;
            				case (int)4: {
HXLINE( 595)					this->deleteCoolText();
            				...
            				break;
            				case (int)5: {
HXLINE( 601)					this->createCoolText(::Array_obj< ::String >::fromData( _hx_array_data_8ca18d79_22,2),-40);
            				}
            				break;
            				case (int)7: {
