...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_482_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",482,0x0d86f62d)

void SongMetadata_obj::__construct(::String song,int week,::String songCharacter,int color){
            	HX_STACKFRAME(&_hx_pos_66f21fcacf595f6d_482_new)
HXLINE( 488)		this->folder = HX_("",00,00,00,00);
HXLINE( 487)		this->color = -7179779;
HXLINE( 486)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 485)		this->week = 0;
HXLINE( 484)		this->songName = HX_("",00,00,00,00);
HXLINE( 492)		this->songName = song;
HXLINE( 493)		this->week = week;
HXLINE( 494)		this->songCharacter = songCharacter;
HXLINE( 495)		this->color = color;
HXLINE( 496)		this->folder = ::Paths_obj::currentModDirectory;
HXLINE( 497)		if (::hx::IsNull( this->folder )) {
HXLINE( 497)			this->folder = HX_("",00,00,00,00);
            		}
            	}
