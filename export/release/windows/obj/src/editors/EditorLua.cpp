...
HXLINE( 214)					ret = ::llua::Convert_obj::toHaxeObj(l,v);
            				...
            				default:{
HXLINE( 214)					ret = null();
HXDLIN( 214)					 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN( 214)					::String _hx_tmp1 = (HX_("return value not supported\n",48,41,fb,c8) + ::Std_obj::string(::Type_obj::_hx_typeof(v)));
HXDLIN( 214)					_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("llua/Convert.hx",6e,6a,e3,49),103,HX_("llua.Convert",31,b8,44,19),HX_("fromLua",6e,2a,fd,57)));
            				}
            			}
...
HXLINE( 246)				ret = ::llua::Convert_obj::toHaxeObj(l,-1);
            			...
            			default:{
HXLINE( 246)				ret = null();
HXDLIN( 246)				 ::Dynamic this1 = ::haxe::Log_obj::trace;
HXDLIN( 246)				::String this2 = (HX_("return value not supported\n",48,41,fb,c8) + ::Std_obj::string(::Type_obj::_hx_typeof(-1)));
HXDLIN( 246)				this1(this2,::hx::SourceInfo(HX_("llua/Convert.hx",6e,6a,e3,49),103,HX_("llua.Convert",31,b8,44,19),HX_("fromLua",6e,2a,fd,57)));
            			}
            		}
